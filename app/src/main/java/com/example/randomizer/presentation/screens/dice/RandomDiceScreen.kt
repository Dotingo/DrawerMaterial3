...
fun DiceView(
    ...
    val diceIcon = when (diceType) {
        DiceType.D4 -> R.drawable.dice4
        DiceType.D6 -> R.drawable.dice6
        DiceType.D8 -> R.drawable.dice8
        DiceType.D10 -> R.drawable.dice10
        DiceType.D12 -> R.drawable.dice12
        DiceType.D20 -> R.drawable.dice20
    }
    ...
    Box(
        ...
        Icon(painter = painterResource(id = diceIcon), contentDescription = "dice")
